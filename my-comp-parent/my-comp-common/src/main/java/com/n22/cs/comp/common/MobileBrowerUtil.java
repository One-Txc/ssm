...
public class MobileBrowerUtil {
	 ...
	 * @throws IOException
	 */
	public static boolean isMobile(HttpServletRequest request) throws IOException {
		...
		if (null == session.getAttribute("ua")) {
			try {
				...
				isFromMobile = MobileBrowerUtil.check(userAgent);
				// 判断是否为移动端访问
				if (isFromMobile) {
