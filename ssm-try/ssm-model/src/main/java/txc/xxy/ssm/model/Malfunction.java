...
public class Malfunction implements Serializable {
	...
	private String sourceType;		//故障来源

	private String cateType;		//故障分类代码[code1-code2]

	private String solveType;		//解决分类[code1-code2]

	private String solveSource;		//解决方案来源代码
	...
	public String getMalfNo() {
		return malfNo;
	}

	public void setMalfNo(String malfNo) {
		this.malfNo = malfNo == null ? null : malfNo.trim();
	}
	...
	public void setSolveType(String solveType) {
		this.solveType = solveType == null ? null : solveType.trim();
	}

	public String getSolveSource() {
		return solveSource;
	}

	public void setSolveSource(String solveSource) {
		this.solveSource = solveSource == null ? null : solveSource.trim();
	}
	...
	public String toString() {
		...
		sb.append(" [");
		sb.append("malfNo=").append(malfNo);
		...
		sb.append(", solveType=").append(solveType);
		sb.append(", solveSource=").append(solveSource);
